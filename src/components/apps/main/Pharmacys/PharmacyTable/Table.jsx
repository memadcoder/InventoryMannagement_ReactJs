...
export default function ProductListTable() {
  ...
  const [pharmacy, setPharmacy, headCells] = useContext(PharmacyContext);
  ...
  const emptyRows =
    rowsPerPage - Math.min(rowsPerPage, pharmacy.length - page * rowsPerPage);
        ...
        <Paper className={classes.paper}>
          ...
          <TableContainer>
            ...
            >
              ...
              />
              <TableBody>
                {stableSort(pharmacy, getComparator(order, orderBy))
